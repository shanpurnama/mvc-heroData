...
if (command[0] === 'register') {
    ...
    console.log('<userName> <userPassword> <heroId> <heroName> <heroAvatar> <heroRole> <heroSpeacilly>')
    console.log('')
    console.log('====== delete ======')
    console.log('user must input userName and userPassword when user will delete, and then user must admin ==')
    console.log('<userName> <userPassword> <userName> <userPassword> <user_role = admin>')
    console.log('')
    console.log('====== update ======')
    console.log('this program user will update data hero from data base')
    console.log('<userName> <userPassword> <heroId> <heroName> <heroAvatar> <heroSpecially>')
}